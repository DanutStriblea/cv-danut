  ...
  useEffect(() => {
    const applyPosition = () => {
      ...
      if (vw <= 900) {
        ...
        setStyleImportant(el, "position", "fixed"); // păstrăm elasticitatea la scroll
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .zoom-controls {
            ...
            gap: 12px;
            position: fixed; /* păstrează elasticitatea la scroll */
            left: 50%;
          ...
          .zoom-btn:active {
            transform: scale(1); /* revine imediat vizual */
            box-shadow: 0 8px 20px rgba(2,6,23,0.18);
          }
        }
